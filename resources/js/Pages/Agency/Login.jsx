...
export default function AgencyLogin() {
    ...
    return (
        <AuthSplitLayout
            ...
            description={
                t("landlord.auth.agency_login_description") ||
                "Enter your agency ID to sign in to your workspace."
            }
            footer={
        ...
        >
            ...
            <form onSubmit={submit} className="space-y-4">
                <div className="space-y-2">
                    <Label htmlFor="agency_path">
                        {t("landlord.auth.agency_path")}
                    </Label>
                    <Input
                        id="agency_path"
                        type="text"
                ...
                <Button
                    type="submit"
                    className="w-full"
                    disabled={processing || !data.agency_path.trim()}
                >
                    {t("landlord.auth.continue_to_login") ||
                        "Continue to login"}

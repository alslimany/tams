...
export default function Create() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('landlord.airports.store'));
    };
        ...
        <LandlordLayout>
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Create Airport</h1>
                        <p className="text-muted-foreground">
                            Add a new airport with multi-language support
                        </p>
                    </div>
                </div>
                        ...
                        <div className="lg:col-span-2">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Enter airport details in all supported languages
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex justify-end gap-4">
                                ...
                                <Button type="submit" disabled={processing}>
                                    ...
                                    {processing ? 'Creating...' : 'Create Airport'}
                                </Button>
                            </div>
                        </div>
                    </div>
